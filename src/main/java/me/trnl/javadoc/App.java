...
public class App {
    ...
    public App() throws PlexusContainerException, ComponentLookupException {
    ...
    public static void searchAndDump(Indexer nexusIndexer, String descr, Query q) throws IOException {
    ...
    public static void searchGroupedAndDump(Indexer nexusIndexer, String descr, Query q, Grouping g) throws IOException {
        System.out.println("Searching for " + descr);
